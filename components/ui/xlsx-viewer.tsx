...
function XlsxWorkbookScroller({
  ...
  const { ref: libraryViewportRef, ...restViewportProps } = viewportProps

  return (
    <ScrollAreaPrimitive.Root className="relative h-full min-h-0 w-full min-w-0 flex-1">
      <ScrollAreaPrimitive.Viewport
        data-slot="scroll-area-viewport"
        className="size-full rounded-[inherit] outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50"
        {...restViewportProps}
        ref={mergeElementRefs(libraryViewportRef, viewportRef)}
      >
        {children}
      </ScrollAreaPrimitive.Viewport>
      ...
      <ScrollAreaPrimitive.ScrollAreaScrollbar
        ...
        className="flex h-2.5 flex-col touch-none border-t border-t-transparent p-px transition-colors select-none"
      >
        <ScrollAreaPrimitive.ScrollAreaThumb className="relative flex-1 rounded-full bg-border" />
      </ScrollAreaPrimitive.ScrollAreaScrollbar>
...
export function renderXlsxScroller({
  ...
  return (
    <XlsxWorkbookScroller viewportProps={viewportProps}>
      {children}
    </XlsxWorkbookScroller>
  )
}
  ...
  return (
    ...
    >
      ...
      >
        <div
          ref={scrollRef}
          className="h-10 w-full overflow-x-auto overflow-y-hidden"
        >
